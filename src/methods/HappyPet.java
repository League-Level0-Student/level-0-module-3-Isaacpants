...
int happy = 0;
	public static void main(String[] args) {
		...
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
			...
			int task = JOptionPane.showOptionDialog(null, "what do you want to do with your pet", "pet choice", 0, JOptionPane.INFORMATION_MESSAGE, null,
					new String[] { "cuddle", "food and water", "groom" }, null);
	...
	void food() {
		JOptionPane.showMessageDialog(null, "SLUUUUURP");
	}
